...
<main id="main-content" class="project">
    <section id="hero" class="container">
        ...
        <div class="project-hero-meta section-shell flex-wrap">
            ...
            <div class="meta-item">
                ...
                <div class="meta-value">Brand Identity · UX/UI · Prototype</div>
            </div>
            <div class="meta-item">
        ...
        <div class="two-column-grid-twothirds">
            ...
            <div class="sidebar">
                <div class="info-card">
                    ...
                    <h4>Flexina</h4>
                    <p>Invoicing & billing SaaS for freelancers and small businesses. Available on all devices via web app.</p>
                </div>
                <div class="info-card info-card-burgandy">
                    <p class="label-dark">My Role</p>
                    <h4 class="dark-mode-txt">UI/UX Designer</h4>
                    <p class="dark-mode-txt">UX research · Information architecture · UI design · Adobe XD prototype · Dev handoff</p>
                </div>
                <div class="info-card">
                    <p class="label">Scope</p>
                    <h4>Full marketing website</h4>
                    <p>Multi-page site introducing the product, its features, pricing, and driving free trial sign-ups.</p>
                </div>
                <div class="info-card">
                    <p class="label">Tools</p>
                    <h4>Adobe XD</h4>
                    <p>High-fidelity prototype with interactions, responsive layouts across all breakpoints.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="two-column-grid">
            ...
            <div class="project-challenge-imgs">
                ...
                <!-- <div class="img-placeholder" style="height: 220px;">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><path d="M21 15l-5-5L5 21"></path></svg>
                    <span>Brief & project scope document</span>
                </div> -->
            </div>
        </div>
    </section>
    <section id="research" class="container">
        ...
        <div class="project-challenge-imgs two-column-grid">
            <div>
        ...
        <div class="three-column-grid">
            <div class="info-card">
                ...
                <h4>Simplicity is the product</h4>
                <p>Freelancers abandon invoicing tools that feel complex. If the website itself felt hard to navigate, users would assume the product did too. Clarity had to come before features.</p>
            </div>
            <div class="info-card">
        ...
        <div class="two-column-grid-onethrid">
            <div class="info-steps">
                <div class="info-step display-flex-mobile">
                    <div class="num-oultine">01</div>
                    <div class="info-step-content">
                        <h4>Hero section does the heavy lifting</h4>
                        <p>Lead immediately with product value, device mockups showing all screen sizes, and a bold free-trial CTA. Zero ambiguity about what Flexina does in the first 5 seconds.</p>
                    </div>
                </div>
                <div class="info-step display-flex-mobile">
            ...
            <div class="project-challenge-imgs style="height: 100%;">
                <div class="img-placeholder"  style="height:320px;">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><path d="M21 15l-5-5L5 21"></path></svg>
                    <span>Page architecture / sitemap diagram</span>
                </div>
    ...
    <section id="ui-branding" class="container">
        ...
        <div class="two-column-grid">
            <div class="info-card">
                ...
                <div class="swatches">
                    <div class="sw"><div class="sw-dot" style="background:#049BD6"></div><p>#049BD6<br>Primary</p></div>
                    <div class="sw"><div class="sw-dot" style="background:#DEE7ED;border:1px solid #dbeafe"></div><p>#DEE7ED<br>Light</p></div>
                    <div class="sw"><div class="sw-dot" style="background:#1C3C75"></div><p>#1C3C75<br>Deep</p></div>
                    <div class="sw"><div class="sw-dot" style="background:#F8FAFC;border:1px solid #e2e8f0"></div><p>#F8FAFC<br>White</p></div>
                    <div class="sw"><div class="sw-dot" style="background:#1A1A1A"></div><p>#1A1A1A<br>Slate</p></div>
                </div>
                <p>A clean blue-anchored palette: confident primary for CTAs and highlights, white for breathing room, deep slate for text. The palette communicates professional reliability without feeling corporate or cold.</p>
            </div>
            <div class="info-card">
                <p class="info-card-label">Typography System</p>
                <div class="type-sample--flexina-h1">Aa Bb</div>
                <div class="type-sample--flexina-h1"><strong>Bold</strong>Bold</div>
                <p>Clean, geometric, highly legible at all sizes. Used for body copy, UI labels, CTAs, and nav. The weight range provides all the hierarchy needed without adding a third typeface.</p>
            </div>
        </div>
    </section>
